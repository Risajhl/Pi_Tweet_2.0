...
public class MultipleToGroupsController implements Initializable {
    ...
    public void add(){
        NewTextEvent newTextEvent=new NewTextEvent(this,groupNameField.getText());
    ...
    public void addToUsername(String username){
        if(groupNamesArea.getText()!=null && !groupNamesArea.getText().equals(""))
            groupNamesArea.setText(groupNamesArea.getText()+"\n"+username);
        else groupNamesArea.setText(username);
